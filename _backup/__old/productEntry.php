...
?>
		...
		<section id="input-area">
			...
			<div class="container" id="product-entry">
				...
				<form method="post" class="well" id="add-form" action="">
					<div class="row">
						<div class="form-group" id="stock-radio">
			...
			<div class="container" id="block-location">
				...
				<form method="post" class="well" id="block-form" action="">
					<div class="row">
						<div class="form-group col-md-3" id="block-input">
		...
		<section id="products-area">
			<div class="container">	
				...
				<table class="table table-striped table-bordered nowrap" id="table-entry" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Date</th>
							<th>Emplacement</th>
										...
										<form method="post" action="" id="plus-form">
											...
											<div class="row">
												<div class="form-group col-md-7">
													...
													<input type="text" class="form-control" id="plus-comment" name="plus-comment" readonly />
												</div>
											</div>
											<input type="hidden" id="plus-id" name="plus-id" />
											<input type="hidden" id="plus-stock" name="plus-stock" />
										</form>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Annuler</button>
										...
										<form method="post" action="" id="minus-form">
											...
											<div class="row">
												<div class="form-group col-md-7">
													...
													<input type="text" class="form-control" id="minus-comment" name="minus-comment" readonly />
												</div>
											</div>
											<input type="hidden" id="minus-id" name="minus-id" />
											<input type="hidden" id="minus-stock" name="minus-stock" />
										</form>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Annuler</button>
										...
										<form method="post" action="" id="delete-form">
											...
											<div class="row">
												<div class="form-group col-md-7">
													...
													<input type="text" class="form-control" id="delete-comment" name="delete-comment" readonly />
												</div>
											</div>
											<input type="hidden" id="delete-id" name="delete-id" />
											<input type="hidden" id="delete-stock" name="delete-stock" />
										</form>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Annuler</button>
										...
										<form method="post" action="" id="transfer-form">
											...
											<div class="row">
												<div class="form-group col-md-7">
													...
													<input type="text" class="form-control" id="transfer-comment" name="transfer-comment" readonly />
												</div>
											</div>
											<input type="hidden" id="transfer-id" name="transfer-id" />
											<input type="hidden" id="transfer-stock" name="transfer-stock" />
										</form>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Annuler</button>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form method="post" action="" id="update-form">
											...
											<input type="hidden" id="update-stock" name="update-stock" />
										</form>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Annuler</button>
